...
public class Main {
    ...
    static int maxV = 2000;
    static Reader s = new Reader();
    static int[] problemAntiscore = new int[maxV],solvedProblems = new int[maxV];
    static int[][] solved = new int[maxV][maxV]; 
    static int n,t,p;
    static int calcScore(int person){
        int score = 0 ; 
        for(int j = 0 ; j < t ; j++){
            if(solved[person][j]==1)
